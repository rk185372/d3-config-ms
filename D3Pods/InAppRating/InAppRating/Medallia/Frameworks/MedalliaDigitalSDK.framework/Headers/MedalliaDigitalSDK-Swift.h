...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, MDEngagementType, closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, MDFormTriggerType, closed) {
/// Code trigger type
...
typedef SWIFT_ENUM(NSInteger, MDLogLevel, closed) {
  MDLogLevelOff = 0,
  MDLogLevelFatal = 1,
  MDLogLevelError = 2,
  MDLogLevelWarn = 3,
...
typedef SWIFT_ENUM(NSInteger, MDSDKFrameworkType, closed) {
